...
namespace Konoha.Services.EmailHelper;
    ...
    public class EmailService(ISmtpClient smtpClient,ILogger<EmailService> logger,IConfiguration configuration) : IEmailService
    {
        ...
        public async Task SendEmailAsync(EmailModel email)
        {
            ...
            _logger.LogInformation("EMAIL SENT");
                ...
                throw new KonohaException(KonohaException.InternalServerError, $"Failed to Send Email: {ex.Message}");
            }
        }
    }