...
namespace Konoha.Controllers;
    ...
    [ApiController]
    [Route("api/v1.0")]
    public class OtpVerificationController(IOtpVerificationService otpVerificationService,ILogger<OtpVerificationController> logger) : ControllerBase
    {
        ...
        {   
            ...
            return Ok("User Verified Successfully");
                ...
                throw new KonohaException(KonohaException.InternalServerError,$"Failed to verify user: {e.Message} ");
            }
        }
    }